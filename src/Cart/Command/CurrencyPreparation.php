 ...
 * @subpackage   Helpers
 */
class CurrencyPreparation implements ItemPreparer
{
    protected $formatter;
    protected $gateway;
    protected $realCurrency;

    public function __construct(Formatter $formatter, RealCurrency $realCurrency, CurrencyGateway $gateway)
    {
    ...
    public function prepare(Session $cartSession)
    {
        ...
        $amountFormatted = $this->formatter->formatCurrency($money);
